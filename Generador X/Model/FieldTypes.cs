...
namespace Generador_X.Model
{
    public class FieldTypes
    {
        public static Dictionary<EFieldName, FieldType> Types = new Dictionary<EFieldName, FieldType>
        {
            ...
            {EFieldName.Hash, new FieldType("Hash", "VARCHAR(80)", EFieldName.Hash, ECategory.Aleatorio, EBCategory.Random, EBFieldType.Hash, " \n\r \n\r ") },
            {EFieldName.Bool, new FieldType("Bool", "VARCHAR(80)", EFieldName.Bool, ECategory.Aleatorio, EBCategory.Random, EBFieldType.Bool, " \n\r \n\r ") },
